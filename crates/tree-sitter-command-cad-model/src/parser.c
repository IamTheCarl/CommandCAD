...
enum ts_symbol_identifiers {
  ...
  sym_binary = 55,
  sym_integer = 56,
  sym_signed_integer = 57,
  sym_unsigned_integer = 58,
  sym_number = 59,
  sym__float = 60,
  sym__unit = 61,
  sym_scalar = 62,
  ...
  sym_if = 69,
  sym_path = 70,
  sym_declaration_type = 71,
  sym_parenthesis = 72,
  sym_list = 73,
  sym_struct_member = 74,
  sym__struct_final_element = 75,
  sym_struct_definition = 76,
  sym_dictionary_member_assignment = 77,
  sym_dictionary_construction = 78,
  sym_closure_definition = 79,
  aux_sym_path_repeat1 = 80,
  aux_sym_list_repeat1 = 81,
  aux_sym_struct_definition_repeat1 = 82,
  aux_sym_dictionary_construction_repeat1 = 83,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [209] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2, 0, 0), SHIFT_REPEAT(147),
  ...
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dictionary_construction_repeat1, 2, 0, 0),
  [331] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dictionary_construction_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_member, 2, 0, 7),
  ...
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary, 2, 0, 0),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__struct_final_element, 1, 0, 0),
  [350] = {.entry = {.count = 1, .reusable = true}}, SHIFT(140),
  [352] = {.entry = {.count = 1, .reusable = true}}, SHIFT(123),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 1, 0, 0),
  [356] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_octal, 2, 0, 0),
  [360] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [362] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hex, 2, 0, 0),
  [366] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [368] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__struct_final_element, 2, 0, 0),
