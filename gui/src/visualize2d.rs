 ...
 */
use egui::{
    Color32, Mesh, Painter, Pos2, Rect, Sense, Shape, StrokeKind, Ui, Vec2, emath::TSTransform, epaint::{ColorMode, PathShape, PathStroke}
};
...
impl ViewState2D {
    ...
    pub fn update(&mut self, ui: &mut Ui, draw_area: Rect) {
